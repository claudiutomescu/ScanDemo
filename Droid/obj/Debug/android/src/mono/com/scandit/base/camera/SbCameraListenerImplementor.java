		...
		com.scandit.base.camera.SbCameraListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Scandit.Base.Camera.ISbCameraListenerImplementor, ScanditSDK, Version=4.4.1.0, Culture=neutral, PublicKeyToken=null", SbCameraListenerImplementor.class, __md_methods);
	}
	...
	public SbCameraListenerImplementor () throws java.lang.Throwable
	{
		...
		if (getClass () == SbCameraListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Scandit.Base.Camera.ISbCameraListenerImplementor, ScanditSDK, Version=4.4.1.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
